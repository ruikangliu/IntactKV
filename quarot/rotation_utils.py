...
from quarot.hadamard_utils import random_hadamard_matrix, apply_exact_had_to_linear, is_pow2
...
def get_orthogonal_matrix(size, device=utils.DEV):
...
def add_qk_rotation_wrapper_after_function_call_in_forward(module, function_name, *args, **kwargs):
    ...
    '''
    import quarot.monkeypatch as monkeypatch
    import functools
